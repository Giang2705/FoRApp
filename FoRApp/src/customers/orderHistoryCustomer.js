...
const data = [
    { image: require("../../assets/sorrento.jpg"), name: 'fOOD1', price: 65000 , quantity: 1, orderTime: '5 Nov 2023, 12:30'},
    { image: require("../../assets/sorrento.jpg"), name: 'FOOD 123', price: 400000, quantity: 6, orderTime: '3 Nov 2023, 12:30' },
    { image: require("../../assets/sorrento.jpg"), name: 'F', price: 250000, quantity: 4, orderTime: '3 Nov 2023, 14:30' },
  ];
...
export default function OrderHistoryCustomer({ navigation }) {

    const movingNotification = () => {
        navigation.navigate('NotificationCustomer');
      };
        ...
        <View style={styles.container}>
            <View style = {styles.mainContainer}>
                <View style={styles.frameTittle}>
                    ...
                    <TouchableOpacity onPress={movingNotification}>
                        ...
                        <View key={index} style={styles.boxView}>    
                            <View style={styles.frameBox}>
                                ...
                                <View style = {styles.textContent}>
                                    ...
                                    <Text style = {styles.textPlace}>{item.orderTime}</Text>
                                </View>
                            </View>
                        </View>
                    ))}
