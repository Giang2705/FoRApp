...
const data = [
    { image: require("../../images/147137.png"), name: 'fOOD1', price: 65000 , quantity: 1, place: 'B2 - F3'},
    { image: require("../../images/147142.png"), name: 'FOOD 123', price: 400000, quantity: 6, place: 'B2 - F3' },
    { image: require("../../images/557643.png"), name: 'F', price: 250000, quantity: 4, place: 'B2 - F3' },
  ];
...
export default function DeliveryShopownerPage({ navigation }) {
            ...
            <View style={styles.bottomContainer}>
                <View style={styles.bottomNav}>
                    ...
                    <IconButton icon={props => <Icon name="notifications-outline" {...props} size={30}/>}
                                ...
                                margin={8}
                                onPress={()=>navigation.navigate()}/>
                    <IconButton icon={props => <Icon name="archive" {...props} size={33}/>} 
                                color="#C51606"
                                margin={8}
